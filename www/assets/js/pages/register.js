...
function Register() {
  ...
  if (voornaam == '' || achternaam == '' || geslacht == '' || geboorte_datum == '' || bio == '' || wachtwoord == '' || email == '') {
    ...
    FYSCloud.Utils.getDataUrl(avatar).done(function(data) {
      FYSCloud.API.uploadFile(
        ...
        FYSCloud.API.queryDatabase(
          "INSERT INTO gebruiker(voornaam, tussenvoegsel, achternaam, email, wachtwoord, geslacht, geboortedatum, profiel_foto, bio) VALUES(?,?,?,?,?,?,?,?,?)", [voornaam, tussenvoegsel, achternaam, email, wachtwoord, geslacht, geboorte_datum, url, bio]
        ).done(function(data) {
          console.log(data);
